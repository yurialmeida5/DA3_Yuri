...
data_dir <- "D:/CEU/Data_Analysis_3/DA3_Yuri/"

# set data dir, load theme and functions

source(paste0(data_dir,"theme_bg.R"))
source(paste0(data_dir,"da_helper_functions.R"))
...
#import data
daily_agg<-read.csv("D:/CEU/Data_Analysis_3/da_data_repo/swim-transactions/clean/swim_work.csv") %>% 
...
stargazer(reg6$finalModel, type = "text", digits=2)
