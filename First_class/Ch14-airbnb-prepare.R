...
data_path <- "D:/CEU/Data_Analysis_3/da_case_repo"

# data used
data_in <- paste(data_path,"airbnb","clean/", sep = "/")

use_case_dir <- "D:/CEU/Data_Analysis_3/DA3_Yuri/"
...
#-------------------------------------------------------
# Import data
data <- read_csv("D:/CEU/Data_Analysis_3/da_data_repo/airbnb/clean/airbnb_london_cleaned.csv")
