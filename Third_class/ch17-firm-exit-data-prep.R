...
data <- read_csv("D:/CEU/Data_Analysis_3/da_data_repo/bisnode-firms/clean/cs_bisnode_panel.csv")
...
write_csv(data, "D:/CEU/Data_Analysis_3/da_data_repo/bisnode-firms/clean/bisnode_firms_clean.csv")
write_rds(data, "D:/CEU/Data_Analysis_3/da_data_repo/bisnode-firms/clean/bisnode_firms_clean.rds")
