...
data <- read_rds("D:/CEU/Data_Analysis_3/da_data_repo/bisnode-firms/clean/bisnode_firms_clean.rds")
...
########################### Analysis (cm) ######################################
# Reference in this case is reality 

# Default means the company leaving the business:
# You should change the threshold focusing which kind of error we want to achieve

# threshold 0.75 - cm$`0.75`
...
############### Based on the parameters defined (Logit Summary) ######################
# The best threshold is going to be defined based on the parameters of cost FN/FP
