...
#-------------------------------------------------------
# Import data
data <- read_csv("D:/CEU/Data_Analysis_3/da_data_repo/airbnb/clean/airbnb_london_cleaned_book.csv")
...
write_csv(data, "D:/CEU/Data_Analysis_3/da_data_repo/airbnb/clean/airbnb_london_workfile_book.csv")


#--------------------------------
data <- read_csv("D:/CEU/Data_Analysis_3/da_data_repo/airbnb/clean/airbnb_london_workfile_book.csv")
...
write_csv(data, "D:/CEU/Data_Analysis_3/da_data_repo/airbnb/clean/airbnb_london_workfile_adj_book.csv")
